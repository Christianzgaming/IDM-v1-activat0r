...
set "blank="
set "mas=https://github.com/Christianzgaming/activat0r/wiki/"
...
echo:
echo:
call :_color2 %_White% "             " %_Green% "Create By ChanZAi"
echo:            ___________________________________________________ 
echo:
echo:               Telegram: @ModByChanZAi
echo:               Github: https://github.com/Christianzgaming
echo:            ___________________________________________________ 
echo:                                                               
echo:               [1] Activate
echo:               [2] Freeze Trial
