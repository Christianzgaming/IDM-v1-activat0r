...
$DownloadURL = 'https://raw.githubusercontent.com/Christianzgaming/IDM-v1-activat0r/refs/heads/main/IAS.cmd'
$DownloadURL2 = 'https://raw.githubusercontent.com/Christianzgaming/IDM-v1-activat0r/refs/heads/main/IAS.cmd'
